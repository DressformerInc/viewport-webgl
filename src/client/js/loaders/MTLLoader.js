...
THREE.MTLLoader.prototype = {
    ...
    parse: function (text) {
        ...
        console.log('material creator options:', this.options);
...
THREE.MTLLoader.MaterialCreator.prototype = {
    ...
    parseTextureParams: function (str) {
        var words = str.split(' '),
            params = {
                file: ''
            };
        ...
        for (var prop in mat) {
            ...
            switch (prop.toLowerCase()) {
                ...
                case 'map_kd':
                    ...
                    params['map'] = this.loadTexture(p.url);
                    params['map'].wrapS = this.wrap;
                    params['map'].wrapT = this.wrap;

                    console.log('mtlLoader diffuse map:', params['map']);
                    break;
